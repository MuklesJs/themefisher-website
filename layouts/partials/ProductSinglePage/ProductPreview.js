...
const ProductPreview = ({ singleProduct, slug }) => {
  const { title, demo, image, type } = singleProduct.frontmatter;
  const frameSrc = demo ? demo : `https://demo.themefisher.com/${slug}/`;
  ...
  return (
    <div className="mb-7 xl:mb-0">
      {/* browser preview */}
      <div key={slug} className="browser-preview hidden md:block">
        {/* preview header */}
        <div className="browser-preview-header">
          ...
          <div className="browser-preview-header-buttons">
            <a
              ...
              href={
                type == "hugo"
                  ? frameSrc.replace("/site", "") + "?ref=themefisher"
                  : frameSrc
              }
            >
              <svg
        ...
        <div className="browser-preview-body">
          ...
          <span className="browser-preview-thumbnail">
            <Image src={image} height={250} width={750} alt={title} />
          </span>
        </div>
      </div>
